...
import { signInWithGoogle, signup } from "@/logic/auth";
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full max-w-sm mx-auto">
      <div className="flex flex-row items-center justify-center">
        ...
        <p className="text-xl">Welcome to Clado</p>
      </div>
      <br />
      ...
      <form className="flex flex-col gap-2 w-full" action={signup}>
        ...
        <p className="text-muted-foreground text-xs mt-2">
          ...
          <Link className="hover:italic text-primary" href="/login">
